...
<title>Nomadsmap</title>
	...
	<script src="extras/10-apiroot.js?revision=3"></script>
	<script src="extras/30-curvature.js?revision=3"></script>
	<script src="extras/50-createmap.js?revision=3"></script>
	<style>
		body {
			margin: 0;
