...
<title>Nomadsmap</title>
	...
	<script src="extras/10-apiroot.js?revision=4"></script>
	<script src="extras/30-curvature.js?revision=4"></script>
	<script src="extras/50-createmap.js?revision=4"></script>
	<style>
		body {
			margin: 0;
